...
function generator(ast, templateRuntime) {
...
module.exports = {
    fromString: function(string, templateRuntime) {
        var ast = parser.parse(string);

        return generator(ast, templateRuntime);
    },

    fromAST: function(ast, templateRuntime) {
        return generator(ast, templateRuntime);
    }
};
