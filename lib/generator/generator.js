...
function generator(string, templateRuntime) {
    ...
    function parseAttribute(item) {
        return {
            ...
            "arguments": item.content ?
                traverse(item.content).map(handler) :
    ...
    function buildTmplCall(item) {
        ...
        var functionArguments = traverse(item.content.slice(1, -1)).map(handler);
                                ...
                                "body": [
                                    {
                                        ...
                                        "argument": {
                                            ...
                                            "elements": traverse(ifTrue).map(handler)
                                        }
                                    }
                                ]
                            },
                                ...
                                "body": [
                                    {
                                        ...
                                        "argument": {
                                            "type": "ArrayExpression",
                                            "elements": traverse(ifFalse).map(handler)
                                        }
                                    }
                                ]
                            },
