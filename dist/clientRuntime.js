	...
	function createVdom(string, state) {
	    ...
	    function handler() {
	        ...
	        if (this.node.type === 'Tag' && this.node.name === 'TMPL_LOOP') {
	            ...
	            return this.update(lookupValue(propertyName).map((function (item, index, arr) {
